...
\textbf{\Huge\sffamily\bfseries {机器翻译：基础与模型}}\\[\baselineskip]
...
{\large \textsc{东北大学自然语言处理实验室}}\\
\vspace{0.8em}
{\large \&} \\
\vspace{0.8em}
{\large \textsc{小牛翻译}}

\vspace*{4\baselineskip} % Whitespace at the bottom of the page
...
\noindent Copyright \copyright\ 2020-2024 肖桐\ \ 朱靖波\\
