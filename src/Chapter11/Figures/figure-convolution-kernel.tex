...
\node(num1)[num]{-1};
\node(num2)[num,below of = num1,yshift= -0.8cm]{};
\node(num3)[num,below of = num2,yshift= -0.8cm]{};
\node(num4)[num,right of = num1,xshift= 0.8cm]{0};
\node(num5)[num,below of = num4,yshift= -0.8cm]{};
\node(num6)[num,below of = num5,yshift= -0.8cm]{};
...
\node(num22)[num,below of = num2,xshift= -0.5cm,yshift= -0.5cm]{};
\node(num33)[num,below of = num3,xshift= -0.5cm,yshift= -0.5cm]{};
\node(num44)[num,right of = num4,xshift= -0.5cm,yshift= -0.5cm]{1};
\node(num55)[num,below of = num5,xshift= -0.5cm,yshift= -0.5cm]{};
\node(num66)[num,below of = num6,xshift= -0.5cm,yshift= -0.5cm]{};
