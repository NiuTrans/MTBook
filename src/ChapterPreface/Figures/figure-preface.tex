...
\node [secnode,anchor=south west,fill=gray!20,minimum width=14.0em,align=center] (sec13) at ([yshift=0.5em,xshift=0.5em]part4.south west) {\Large{\yh{?}}};
\node [secnode,anchor=west,fill=gray!20,minimum width=14.0em,align=center] (sec14) at ([xshift=0.6em]sec13.east) {\Large{\yh{?}}};
\node [secnode,anchor=south west,fill=gray!30,minimum width=9em,minimum height=4.5em,align=center] (sec15) at ([yshift=0.8em]sec13.north west) {\Huge{\yh{?}}};
\node [secnode,anchor=south west,fill=gray!30,minimum width=9em,minimum height=4.5em,align=center] (sec16) at ([xshift=0.8em]sec15.south east) {\Huge{\yh{?}}};
\node [secnode,anchor=south west,fill=gray!30,minimum width=9em,minimum height=4.5em,align=center] (sec17) at ([xshift=0.8em]sec16.south east) {\Huge{\yh{?}}};
\node [secnode,anchor=south west,fill=gray!25,minimum width=28.7em,align=center] (sec18) at ([yshift=0.8em]sec15.north west) {\Large{\yh{?}}};
